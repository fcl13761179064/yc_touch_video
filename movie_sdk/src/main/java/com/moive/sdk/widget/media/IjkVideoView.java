...
package com.moive.sdk.widget.media;
...
import com.moive.sdk.R;
import com.moive.sdk.application.Settings;
import com.moive.sdk.services.MediaPlayerService;
...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    IMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener =
            new IMediaPlayer.OnVideoSizeChangedListener() {
                public void onVideoSizeChanged(IMediaPlayer mp, int width, int height, int sarNum, int sarDen) {
                    Log.d(TAG, "==========onVideoSizeChanged=======mp===");
    ...
    private IMediaPlayer.OnCompletionListener mCompletionListener =
            new IMediaPlayer.OnCompletionListener() {
                public void onCompletion(IMediaPlayer mp) {
                    ...
                    if (mOnIjkPlayerListener != null) {
                        mOnIjkPlayerListener.finishVideo();
                    }
                }
            };
    ...
    private IMediaPlayer.OnErrorListener mErrorListener =
            new IMediaPlayer.OnErrorListener() {
                public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
                    Log.d(TAG, "==========onError=======mp===" + framework_err + "," + impl_err);
    ...
    private OnIjkPlayerListener mOnIjkPlayerListener;


    public void setOnIjkPlayerListener(OnIjkPlayerListener mOnIjkPlayerListener) {
        this.mOnIjkPlayerListener = mOnIjkPlayerListener;
    }
    ...
    public void start() {
        if (isInPlaybackState()) {
            mMediaPlayer.start();
            if (mOnIjkPlayerListener != null) {
                mOnIjkPlayerListener.showVideoPlay();
            }
    ...
    public void pause() {
        ...
        if (isInPlaybackState()) {
            if (mMediaPlayer.isPlaying()) {
                mMediaPlayer.pause();
                if (mOnIjkPlayerListener != null) {
                    mOnIjkPlayerListener.showVideoPause();
                }
    ...
    //意图要播放
    public boolean isTargetIsPlaying() {
        ...
        switch (playerType) {
            ...
            default: {
                ...
                if (mUri != null) {
                    ...
                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec-sync", 1);//同步
                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec-auto-rotate", 1);//使用 mediacodec 时是否根据 meta 信息自动旋转视频
                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec-handle-resolution-change", 1); //使用 mediacodec 时是否处理分辨率改变
                }
     ...
     * 格式化时间
     */
    public static String buildTimeMilli(int timeMs) {
